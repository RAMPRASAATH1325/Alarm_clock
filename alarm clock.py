...
time_format=Label(window, text= "Don't forget to set time in 24 hour format!", fg="Red",bg="#FFFFFF",font=("Arial",15)).place(x=20,y=120)
addTime = Label(window,text = "Hour     Min     Sec",font=60,fg="white",bg="black").place(x = 210)
setYourAlarm = Label(window,text = "Adjust your time: ",fg="Red",bg="#FFFFFF",relief = "solid",font=("Helevetica",15,"bold")).place(x=10, y=40)
...
submit = Button(window,text = "Set Alarm",fg="red",bg="#FFFFFF",width = 15,command = get_alarm_time,font=(20)).place(x =100,y=80)
